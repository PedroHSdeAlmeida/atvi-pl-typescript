...
while (execucao) {
    ...
    console.log(`8 - Atualizar/deletar produtos ou serviços`);
    console.log(`0 - Sair`);
    ...
    switch (opcao) {
        ...
        case 2:
            ...
            break;
        case 3:
            let pegaCpf = entrada.receberTexto(`Por favor, digite o número do cpf do cliente que deseja atualizar/deletar: `)
